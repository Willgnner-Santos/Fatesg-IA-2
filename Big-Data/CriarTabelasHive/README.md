...
Para verificar se os dados foram inseridos corretamente, foi executada uma consulta SELECT.
...
A consulta retornou os dados inseridos. Como pode ser observado na imagem hive1.png, o comando de inserção foi executado duas vezes, resultando em registros duplicados. Além disso, foram identificados problemas de codificação de caracteres (encoding) na exibição dos resultados, substituindo caracteres acentuados por ??.
