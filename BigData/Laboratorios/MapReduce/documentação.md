...
## Objetivo
Este tutorial demonstra como executar um job MapReduce usando o exemplo WordCount do Hadoop em um ambiente de desenvolvimento com Hortonworks Sandbox.

## Pré-requisitos
- Máquina virtual configurada com Hortonworks Sandbox
- Acesso SSH ao ambiente (usando MobaXterm ou similar)
- Interface web do Ambari disponível
- Terminal Linux (Arch Linux usado neste exemplo)
...
Este exercício demonstrou com sucesso o funcionamento do framework MapReduce em um ambiente Hadoop real, mostrando como dados são processados de forma distribuída e os resultados são agregados para fornecer informações úteis sobre o conjunto de dados de entrada.